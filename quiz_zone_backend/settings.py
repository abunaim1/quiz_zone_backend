"""
Django settings for quiz_zone_backend project.
...
SECRET_KEY = 'django-insecure-^&-l@!#sq7^r34%^5iqbo*vc5wsw_u*jvl)lhd#st9n$kt-$2s'
...
ROOT_URLCONF = 'quiz_zone_backend.urls'
...
WSGI_APPLICATION = 'quiz_zone_backend.wsgi.application'
